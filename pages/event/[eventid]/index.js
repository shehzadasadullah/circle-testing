    ...
    if (searchAttendees !== "") {
      ...
      const filteredAttendees = attendeesDataList.filter(
        (f) =>
          ...
          f?.displayName?.toLowerCase().indexOf(searchTermLowerCase) !== -1
      );
      setFilteredAttendeesDataList(filteredAttendees);
    } else {
      setFilteredAttendeesDataList(attendeesDataList);
    ...
    try {
      ...
      fetch(
        ...
        .then((res) => {
          res.map((item) => {
            if (item.result) {
              toast(item?.message?.toUpperCase());
                ...
                try {
                  ...
                  fetch(
                    ...
                    .catch((error) => {
                      ...
                      toast("Error downloading iCal file!");
                    });
                } catch (error) {
                      ...
                      <div className="w-full h-auto flex justify-center items-center flex-col gap-10 p-6">
                        <div className="w-full h-auto bg-[#012432] rounded-xl flex justify-center items-center flex-col p-10">
                          ...
                          <p className="text-[#BDBDBD] w-full lg:w-3/4 mt-4">
                            ...
                            user-friendly app for all devices. Sign up today for
                            a free digital business card and unlock networking
                            success!
                          </p>
              ...
              <>
                <div className="flex w-full mt-4 gap-y-4 flex-col justify-center items-center p-6 bg-[#012432] rounded-xl">
                  <button
                    ...
                    onClick={() => {
                      const hasValidIntegration = thirdPartyIntegrations.some(
                        (fl) => {
                          return (
                            fl.integrationType === "GOOGLECALENDAR" ||
                            fl.integrationType === "OUTLOOK" ||
                        ...
                        <div className="w-full h-auto flex justify-center items-center flex-col gap-10 p-6">
                          <div className="w-full h-auto bg-[#012432] rounded-xl flex justify-center items-center flex-col p-10">
                            ...
                            <p className="text-[#BDBDBD] w-full lg:w-3/4 mt-4">
                              ...
                              the user-friendly app for all devices. Sign up
                              today for a free digital business card and unlock
                              networking success!
                            </p>
                            <div className="flex justify-center items-center flex-row mt-10 w-full">
                              <button
                        ...
                        <div className="w-full h-auto flex justify-center items-center flex-col gap-10 p-6">
                          <div className="w-full h-auto bg-[#012432] rounded-xl flex justify-center items-center flex-col p-10">
                            ...
                            <p className="text-[#BDBDBD] w-full lg:w-3/4 mt-4">
                              ...
                              navigate to Settings page and integrate your
                              calendars.
                            </p>
                            <div className="flex justify-center items-center flex-row mt-10 w-full">
                              <button
