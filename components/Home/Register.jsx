  ...
  return (
    <div className="fixed inset-0  bg-transparent" style={{ zIndex: 1 }}>
      <div className="flex items-center justify-center min-h-screen">
        <div
          className="absolute w-full h-full flex items-center justify-center bg-white p-8 rounded-lg shadow-xl"
          style={{
            width: "420px",
            height: `${
              activeTab == "signin"
        ...
        >
          <div className="fixed inset-0 transition-opacity" aria-hidden="true">
            <div className="flex justify-between items-center  xl:mt-4 ">
