...
import bgImageCircle from "../../public/revamp/circle-bg.png";
// import AOS from "aos";
...
const HeroSection = () => {
  ...
  return (
    ...
    >
      <div
        style={{
          backgroundImage: `url(${bgImageCircle.src})`,
        ...
        >
          <div className="w-full lg:w-[50%] h-full pl-5 pr-5 lg:pl-16 xl:pl-20 2xl:pl-24 gap-2 lg:pr-8">
            ...
            <div className="w-full mt-5 flex flex-col  justify-start h-auto">
              <h2
                ...
                className="flex font18 w-auto p-4 rounded-full border-2 border-[#007bab80]  font-Poppins font-light"
              >
              ...
              <p
                style={{ color: "rgba(255, 255, 255, 0.80)" }}
                className="flex font18 w-auto p-4 mt-3 border-2 border-[#007bab80] rounded-full  font-Poppins font-light"
              >
              ...
              >
                ...
                <span className="ml-3">
                  Know Who You've Met at Every Event!
                </span>
              </p>
            </div>
            <div className="w-full hidden lg:flex justify-center items-center">
              <button
                ...
                className={`w-[50%] mt-10 font14 font-medium rounded-full py-5 font-Montserrat text-[#fff]`}
              >
          ...
          <div className="w-full lg:w-[50%] flex flex-col justify-start items-center h-auto">
            ...
            <button
              ...
              className={`flex lg:hidden px-10 mt-5 mb-5 lg:mt-[-102pt] lg:ml-[-65%] font16 md:font14 font-medium rounded-full py-5 font-Montserrat text-[#fff]`}
            >
              <div className="flex justify-center items-center">
                Create an Event
                <span>
