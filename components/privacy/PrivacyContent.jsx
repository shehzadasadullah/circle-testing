...
Noww, Inc. (“us”, “we”, or “our”) operates https://noww.co and https://www.circle.ooo mobile application (hereinafter referred to as “Service”).
          ...
          <p className="w-full flex items-center justify-center text-center font20 font-Montserrat py-4">
          Our Privacy Policy governs your visit to https://noww.co or https://www.circle.ooo and our web and mobile applications, and explains how we collect, safeguard and disclose information that results from your use of our Service.
          ...
          Definitions: means the https://noww.co website https://www.circle.ooo means progressive web and  mobile applications operated by Noww, Inc.
          </p>
          <p className="w-full flex items-center justify-center font20  text-center py-4 font-Montserrat ">
 ...
 are small files stored on your device (computer or mobile device).
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
          Social Media photo or Links or Profile Info

          </p>
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
          We may use your Personal Data to contact you with newsletters, marketing or promotional materials and other information that may be of interest to you. You may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or accessing the setting in the mobile or web app and de-selecting sharing.
...
While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, non-disclosure agreements, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
          Noww, Inc. /Circle.ooo uses the collected data for various purposes:
...
Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
          Noww, Inc. dba Circle.ooo will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
          If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at team@noww.co.
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
          users are able to change their personal information by emailing us at team@noww.co.
...
Unity Ads is provided by Unity Technologies.
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
          Noww, Inc. uses remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.
