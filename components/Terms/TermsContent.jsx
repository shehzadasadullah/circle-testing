      ...
      <div className="w-full h-full my-8 flex flex-col justify-center items-center gap-4">
        ...
        <ul className="w-full h-full list-decimal list-inside pl-4 flex flex-col justify-center items-center gap-2">
          <p className="w-full flex items-center justify-center text-center font20 font-Montserrat py-4 ">
            Introduction Welcome to Noww, Inc., dba Circle.ooo (“Company”, “we”,
            “our”, “us”)! As you have just clicked our Terms of Service, please
          ...
          <p className="w-full flex items-center justify-center text-center font20 font-Montserrat py-4">
            ...
            of our web pages located at https://noww.co and
            https://www.circle.ooo and our progressive web and mobile
            applications, Circle.ooo (together or individually “Service”)
          ...
          <p className="w-full flex items-center justify-center font20  text-center py-4 font-Montserrat ">
            If you do not agree with (or cannot comply with) support@circle.ooo
          ...
          <p className="w-full flex items-center justify-center font20  text-center py-4 font-Montserrat ">
            ...
            cancel it or Noww, Inc. cancels it. You may cancel your Subscription
            renewal either through your online account management page or by
            contacting Noww, Inc. customer support team.
          </p>
          <p className="w-full flex items-center justify-center font20  text-center py-4 font-Montserrat ">
            ...
            Noww, Inc. with accurate and complete billing information including
            ...
            you automatically authorize Noww, Inc. to charge all Subscription
            fees incurred through your account to any such payment instruments.
          </p>
          <p className="w-full flex items-center justify-center font20  text-center py-4 font-Montserrat ">
            Should automatic billing fail to occur for any reason, Noww, Inc.
          ...
          <div className="flex flex-col">
            <p className="w-full flex flex-col items-center justify-center font20  text-center py-4 font-Montserrat ">
              Free Trial
              <p className="w-full flex items-center justify-center font20  text-center  font-Montserrat ">
                Noww, Inc. may, at its sole discretion, offer a Subscription
          ...
          <p className="w-full flex items-center justify-center font20  text-center py-4 font-Montserrat ">
            ...
            Trial, you will not be charged by Noww, Inc. until Free Trial has
          ...
          <p className="w-full flex items-center justify-center font20  text-center py-4 font-Montserrat ">
            At any time and without notice, Noww, Inc. reserves the right to (i)
          ...
          <div className="flex flex-col">
            <p className="w-full flex flex-col items-center justify-center font20  text-center py-4 font-Montserrat ">
              Fee Changes
              <p className="w-full flex items-center justify-center font20  text-center  font-Montserrat ">
                Noww, Inc., in its sole discretion and at any time, may modify
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
            Noww, Inc. will provide you with a reasonable prior notice of any
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
            Noww, Inc. has the right but not the obligation to monitor and edit
            all Content provided by users.
          </p>
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
            In addition, Content found on or through this Service are the
            property of Noww, Inc. or used with permission. You may not
...
Azure DevOps is a Software as a service (SaaS) platform from Microsoft that provides an end-to-end DevOps toolchain for developing and deploying software.
          ...
          <div className="flex flex-col">
            <p className="w-full flex flex-col items-center justify-center font20  text-center py-4 font-Montserrat ">
              ...
              <p className="w-full flex items-center justify-center font20  text-center  font-Montserrat ">
                ...
                exclusive property of Noww, Inc. and its licensors. Service is
                ...
                the prior written consent of Noww, Inc..
              </p>
            </p>
          </div>
          <div className="flex flex-col">
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
            ...
            email to team@noww.co, with the subject line: “Copyright
          ...
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
            DMCA Notice and Procedure for Copyright Infringement Claims You may
          ...
          <div className="flex flex-col">
            <p className="w-full flex flex-col items-center justify-center font20  text-center py-4 font-Montserrat ">
              ...
              <p className="w-full flex items-center justify-center font20  text-center  font-Montserrat ">
                You may provide us either directly at support@circle.ooo or via
          ...
          <div className="flex flex-col">
            <p className="w-full flex flex-col items-center justify-center font20  text-center py-4 font-Montserrat ">
              ...
              <p className="w-full flex items-center justify-center font20  text-center  font-Montserrat ">
                ...
                out more here: https://docs.rollbar.com/docs/privacy-policy
              </p>
            </p>
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            <p className="w-full flex flex-col items-center justify-center font20  text-center py-4 font-Montserrat ">
              ...
              <p className="w-full flex items-center justify-center font20  text-center  font-Montserrat ">
                ...
                services that are not owned or controlled by Noww, Inc.
              </p>
            </p>
          </div>
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
            Noww, Inc. has no control over, and assumes no responsibility for
            the content, privacy policies, or practices of any third party web
            sites or services. We do not warrant the offerings of any of these
            entities/individuals or their websites.
          </p>
          <p className="w-full flex  items-center justify-center font20  text-center py-4 font-Montserrat ">
            YOU ACKNOWLEDGE AND AGREE THAT Noww, Inc. SHALL NOT BE RESPONSIBLE
          ...
          <div className="flex flex-col">
            <p className="w-full flex flex-col items-center justify-center font20  text-center py-4 font-Montserrat ">
              ...
              <p className="w-full flex items-center justify-center font20  text-center  font-Montserrat ">
                ...
                IT ARISES (INCLUDING ATTORNEYS&apos; FEES AND ALL RELATED COSTS
                ...
                THIS AGREEMENT, PROPERTY DAMAGE, ARISING FROM THIS AGREEMENT AND
                ANY VIOLATION BY YOU OF ANY FEDERAL, STATE, OR LOCAL LAWS,
          ...
          <div className="flex flex-col">
            <p className="w-full flex flex-col items-center justify-center font20  text-center py-4 font-Montserrat ">
              ...
              <p className="w-full flex items-center justify-center font20  text-center  font-Montserrat ">
                ...
                the laws of State of Texas without regard to its conflict of law
                provisions.
              </p>
            </p>
          </div>
